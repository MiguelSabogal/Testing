...
public class ConfigurationFilesReader {
    ...
    private static Properties getProperties(Class<?> clazz, String filePath) {
        try {
            ...
            final String ERROR_MESSAGE = String.format("----------- Property was not found. on %s file.", filePath);
    ...
    public static String getStringProperty(String propertyName) {
        ...
        if (propertyValue != null) {
            ...
            final String ERROR_MESSAGE = String
    ...
    public static Long getLongProperty(String propertyName) {
        ...
        if (propertyValue != null) {
            try {
                ...
                final String ERROR_MESSAGE = String.format("----------- Property %s not a long data type", propertyName);
                throw new Error(ERROR_MESSAGE);
            }
        } else {
